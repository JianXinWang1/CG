...
int main()
{
    ...
    // -------------------------
    Shader shaderGeometryPass("ssr_geometry.vs", "ssr_geometry.fs");
    Shader shaderLightingPass("ssr.vs", "ssr_lighting.fs");
    Shader shaderSSR("ssr.vs", "ssr.fs");
    Shader shaderSSRBlur("ssr.vs", "ssr_blur.fs");


    // load models
    // -----------
    Model backpack("model/ldjj/Raiden Boss_PC_Safe_v1.0.pmx");
    unsigned int water = loadTexture("water.png");
